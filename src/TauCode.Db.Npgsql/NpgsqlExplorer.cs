...
public class NpgsqlExplorer : Explorer
{
    #region Constants
    ...
    public NpgsqlExplorer()
    {
    }

    public NpgsqlExplorer(NpgsqlConnection connection)
        : base(connection)
    {
    }
...
";
    ...
    private NpgsqlConnection GetOpenSqlConnection()
    {
        var connection = this.GetOpenConnection();
        var sqlConnection = connection as NpgsqlConnection;
    ...
    protected override IReadOnlyList<string> GetTableNamesImpl(string schemaName)
    {
        ...
        var connection = (NpgsqlConnection)this.GetOpenConnection();
        using var command = connection.CreateCommand();
